...
//Middleware
const { auth, recoveryTimedOut, checkTimedOut } = require('./middleware/auth');
//Models
...
app.get('/recovery', recoveryTimedOut, (req, res) => {
    if (res.authenticated) {
        ...
        if (Users) {
            if (recoveryEmail === Users.recoveryEmail) {
                ...
                let mailOptions = {
                    ...
                    // text: `Hii ${Users.name}, click on https://pass-manager.cyclic.app/change/${Users.id} to reset your password`
                    text: `Hii ${Users.name}, click on http://127.0.0.1:5009/change/${Users.id} to reset your password`
                };
